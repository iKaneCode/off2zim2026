...
export default function FlightPassengerDetails() {
  ...
  const {
    ...
    travelingWithInfant: travelingWithInfantParam = 'false',
    selectedDepartureFlight = '',
  } = useLocalSearchParams();

  const normalizedPassengers = Array.isArray(passengersParam)
    ? passengersParam[0] || '1'
    : passengersParam;
  const normalizedTravelingWithInfant = Array.isArray(travelingWithInfantParam)
    ? travelingWithInfantParam[0] || 'false'
    : travelingWithInfantParam;
  ...
  const [travelingWithInfant, setTravelingWithInfant] = useState<boolean>(
    normalizedTravelingWithInfant === 'true'
  );
  ...
  const handleContinue = () => {
    ...
    const pricePerSeat = 250; // This should come from the selected flight data
    ...
    router.push({
      ...
      params: {
        type: 'flight',
        flightOperator: serviceProvider,
        fromLocation,
        toLocation,
        departureDate,
        passengers: normalizedPassengers.toString(),
        ...
        <View style={styles.contentWrapper}>
          ...
          >
            ...
            >
              ...
              >
                <ThemedText style={styles.sectionTitle}>Main Passenger</ThemedText>
                ...
                <View style={styles.passengerDetailsForm}>
                  ...
                  <View style={styles.inputColumn}>
                    <ThemedText style={styles.inputLabel}>Passenger Type</ThemedText>
                    <TextInput
                      value="Adult"
                      editable={false}
                      style={[
                  ...
                  >
                    ...
                    <TextInput
                      ...
                      value={sameAsAccountHolder ? accountHolderPhone : cellPhoneNumber}
